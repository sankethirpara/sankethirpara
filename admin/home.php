<?php 
	...
	{
		$vc_name=$_REQUEST['txt_coursename'];
		date_default_timezone_set('Asia/Calcutta');
 	    $vdate=date("Y-m-d H:i:s");
		
		$insertcourse=$db->query("insert into course(course_name,course_date)values('$vc_name','$vdate')") or die("Query Not Work");
		echo "<script type='text/javascript'> alert('Course Detail Successfully Added'); window.location.href='home.php';</script>";
	}
     
    if(isset($_REQUEST['widdel']))
	{
		$vdel=$_REQUEST['widdel'];
		$del_warden=$db->query("delete from warden_reg where warden_id='$vdel'");
		echo "<script type='text/javascript'> alert('Your warden detail successfully remove'); window.location.href='home.php'; </script>";
	}
       ...
       <div class="container">
        <form>
		   	<div class="col-sm-10 dropdown-buttons">   
						<div class="col-sm-3 dropdown-button" style="margin-left: 20%">           			
						  <div class="input-group">
						   <h2><span class="label label-danger">ADD Course</span></h2>
						  </div>
						</div>
						<div class="col-sm-3 dropdown-button">           			
						  <div class="input-group">
							<input class="form-control has-dark-background" name="txt_coursename" id="slider-name" placeholder="Course Name" type="text" required>
						  </div>
						</div>


					  <div class="col-sm-3 submit_button"> 
	   ...
	   <div class="container">
	   	 ...
	   	 <!------------columns----strat--------->
	   	  <div class="col-md-4 faculty_grid">
				...
				$total_rms=$rst_rms[0];
				?>
	   	  		<figcaption><h3 class="person-title"><a href="event_single.html">Total Rooms </a></h3>
	   	  			<span class="person-deg"><?php 
						echo $total_rms ?> Rooms</span>
	   	  			<p><a href="#">Including Boys And Girls Hostel</a></p>
	   	  			<p></p>
	   	  ...
	   	  <div class="col-md-4 faculty_grid">
	   	  	<figure class="team_member">
	   	  		...
	   	  		<figcaption><h3 class="person-title"><a href="event_single.html">Total Students </a></h3>
					<?php
					    $count_std=$db->query("select count(*) from student_reg");
						$res_std=mysqli_fetch_array($count_std);
						$total_std=$res_std[0];
					?>
	   	  			<span class="person-deg">(<?php  echo $total_std; ?>) students</span>
	   	  			<p><a href="#">Including Boys And Girls</a></p>
	   	  			<p></p>
	   	  			<div class="person-social">
	   	  				<ul class="social-person">
	   	  ...
	   	  <div class="col-md-4 faculty_grid">
	   	  	<figure class="team_member">
	   	  		...
	   	  		<figcaption><h3 class="person-title"><a href="event_single.html">Total Book Rooms </a></h3>
	   	  		<?php 
					...
					<span class="person-deg"><?php echo $total_book_rms 
						?> Rooms</span>
	   	  			<p><a href="mailto@example.com">Including Boys And Girls Hostel</a></p>
	   	  			<p></p>
	   	  			<div class="person-social">
	   	  				<ul class="social-person">
	   	  					<li><a href="#">See All</a></li>
		  ...
		  <div class="faculty_top">
	   	  ...
	   	  <div class="col-md-4 faculty_grid">
	   	  	<figure class="team_member">
	   	  		...
	   	  		<figcaption><h3 class="person-title"><a href="event_single.html">Complains</a></h3>
					<?php 
					...
					?>
	   	  			<span class="person-deg"><?php
						echo $total_complain ?> Complains</span>
	   	  			<p><a href="mailto@example.com">Including Boys And Girls Hostel</a></p>
	   	  			<p></p>
	   	  			<div class="person-social">
	   	  				<ul class="social-person">
	   	    ...
	   	    <div class="col-md-4 faculty_grid">
	   	  	<figure class="team_member">
	   	  		...
	   	  		<figcaption><h3 class="person-title"><a href="event_single.html">Courses</a></h3>
					<?php
					...
					?>
						...
						echo $total_course
						?> Course</span>
	   	  			<p><a href="mailto@example.com">Include all departments</a></p>
	   	  			<p></p>
	   	  			<div class="person-social">
	   	  				<ul class="social-person">
	   	  					<li><a href="#">See All</a></li>
	   	   ...
	   	   <!------------columns----Over---------> 
	   	    ...
	   	    <div class="col-md-4 faculty_grid">
	   	  	<figure class="team_member">
	   	  		...
	   	  		<span  style="background-color: burlywood; height:250px; width: 750px " class="img-responsive wp-post-image" alt=""> 
	   	  		<h2 align="center" style="padding-top:60px;"><i class="fa fa-envelope-open" aria-hidden="true"></i></h2> 
	   	  		</span>
	   	  		<div>
	   	  			
	   	  		</div>
	   	  		<figcaption><h3 class="person-title"><a href="event_single.html">Total Leaves</a></h3>
					<?php 
					
					$count_student_leave_info=$db->query("select count(*) from student_leave_info");
	                $rst_student_leave_info=mysqli_fetch_array($count_student_leave_info);
					$total_student_leave_info=$rst_student_leave_info[0];
					?>
	   	  			<span class="person-deg"><?php
						echo $total_student_leave_info ?> Students on Leave</span>
	   	  			<p><a href="mailto@example.com">Include collage vacation or personal reason</a></p>
	   	  			<p></p>
	   	  			<div class="person-social">
	   	  				<ul class="social-person">
	   	  					<li><a href="#">See All</a></li>
